...
The algorithm `vignette("Algorithm")` gets slow, especially for large n. Furthermore, the package is fully written in @RCoreTeam2024R:Computing for now. There might be a faster cpp version in the future, but for now, there are a few ways to increase the computations if you apply the methods to larger data sets.
